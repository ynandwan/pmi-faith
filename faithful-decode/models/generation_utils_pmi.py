    ...
    def beam_sample(
        ...
        **model_kwargs,
        ...
        while True:
            ...
            # hack for pmi beam sampling
            # Pdb().set_trace()
            # TODO delete it after this experiment!
            next_tokens[next_tokens.shape[0] // 2 :] = next_tokens[
                : next_tokens.shape[0] // 2
            ]
            ...
            # if a particular hypo is done, then reset its beam_score to 0
            beam_scores = beam_scores.view(batch_size, num_beams)

            for batch_idx in range(batch_size):
                if beam_scorer._done[batch_idx]:
                    beam_scores[batch_idx] = 0.0
